...
public class RegistrationManager {
    ...
    public static IdentityKeyPair generateIdentityKeyPair() {
        ...
        Log.d("myTag","public key "+djbIdentityKey.getPublicKey().serialize());
        Log.d("myTag","private key "+djbPrivateKey.serialize());
        Log.d("myTag", "publicKey type: " + djbKeyPair.getPublicKey().getType());
